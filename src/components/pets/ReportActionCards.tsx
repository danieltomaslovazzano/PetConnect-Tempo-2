  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-6 bg-white">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {/* Lost Pet Card */}
        <Card className="overflow-hidden border-2 border-red-100 hover:border-red-200 transition-all duration-200 shadow-md">
          <div className="bg-red-50 p-2">
            <CardHeader>
              ...
              <CardDescription className="mt-2">
                Create a lost pet report and let our AI technology help find
                your pet by matching with found pet reports in your area.
              </CardDescription>
            </CardHeader>
          </div>
        ...
        {/* Found Pet Card */}
        <Card className="overflow-hidden border-2 border-green-100 hover:border-green-200 transition-all duration-200 shadow-md">
          <div className="bg-green-50 p-2">
            <CardHeader>
              ...
              <CardDescription className="mt-2">
                Report a found pet to help reunite it with its owner. Our
                platform will search for matching lost pet reports in the area.
              </CardDescription>
            </CardHeader>
          </div>
          <CardContent className="p-6">
